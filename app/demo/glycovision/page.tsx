      ...
      <div className="relative min-h-screen z-10">
        ...
        {state !== 'complete' && (
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
            <div className="rounded-2xl border-2 border-dashed border-amber-200 bg-white/90 backdrop-blur-sm p-8 text-center dark:border-amber-800/50 dark:bg-gray-900/90 dark:backdrop-blur-sm shadow-[0_10px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.4)]">
