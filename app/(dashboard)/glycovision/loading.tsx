...
export default function GlycoVisionLoading() {
  return (
...
export function GlycoVisionProcessingSkeleton() {
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-6 space-y-6">
      <div className="rounded-xl bg-amber-50 border border-amber-100 p-4 flex items-center gap-4">
